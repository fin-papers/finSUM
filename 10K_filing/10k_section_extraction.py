...
def get_price(ticker, year):
	'''
	Returns higest closing stock price of first week of Jan of given year for given company
	'''

	# We will look at stock prices over the past year, starting at January 1, 2016
	start = datetime.datetime(year,1,1)
	end = datetime.datetime(year,1,7)

	# Let's get Apple stock data; Apple's ticker symbol is AAPL
	# First argument is the series we want, second is the source ("yahoo" for Yahoo! Finance), third is the
	# start date, fourth is the end date
